...
class Player(Entity):
    def __init__(self, pos, frames, groups, facing_direction, collision_sprites):  #init acts as a constructor
        super().__init__(pos, frames, groups, facing_direction)
    ...
    def move(self, dt):
        ...
        self.collisons('horizontal')

        self.rect.centery += self.direction.y * self.speed * dt;
        self.hitbox.centery = self.rect.centery;
        self.collisons('vertical')

    def collisons(self, axis):
